...
export async function clientLoader({params}:Route.LoaderArgs) { // to fetch the data from the API
          ...
          <h2 className="text-3xl font-bold text-gray-900">{country.name}</h2>
            ...
            {country.flagUrl && (
                <div className="flex justify-center items-center ">
                    <img src={country.flagUrl} alt="" className="w-56 h-auto border rounded shadow-lg"/>
                </div>
            )}
